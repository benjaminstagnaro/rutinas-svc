# Rutinas — Resumen del microservicio

## Propósito

administra los datos y la lógica del dominio de Rutinas del caso caso15 (FitLife).

## Contexto

- **Caso**: caso15 — FitLife (una plataforma de entrenamiento y bienestar)
- **Microservicio**: rutinas
