# Rutinas — Despliegue y operación
...
| API base | /api/rutinas |

## Docker

```bash
docker build -t duoc/jv0101-caso15-rutinas:1.0.0 .
docker run -p 8080:8080 duoc/jv0101-caso15-rutinas:1.0.0
```
